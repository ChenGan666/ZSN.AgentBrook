...
namespace ZSN.AI.Core.Service
{
    public class FunctionService
    {
        ...
        public FunctionService(IServiceProvider serviceProvider, Assembly[] assemblies)
        {
            ...
            loadContext = new AssemblyLoadContext("LoadContext", true);
        }
        ...
        public void SearchMarkedMethods()
        {
            ...
            foreach (var assembly in _assemblies)
            {
                ...
                foreach (var type in assembly.GetTypes())
                {
                    markedMethods.AddRange(type.GetMethods().Where(m =>
                    {
                        ...
                        return da != null && da.Description.Contains("ZSN.AI.Plugins");
                    }));
                }
            }
            ...
            foreach (var method in markedMethods)
            {
                ...
                var description= method.GetCustomAttribute<DescriptionAttribute>().Description.ConvertToString().Replace("ZSN.AI.Plugins:", "");
